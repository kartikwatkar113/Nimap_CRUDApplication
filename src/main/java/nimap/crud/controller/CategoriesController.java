...
import nimap.crud.service.CategoriesInterface;
...
public class CategoriesController {
	...
	@GetMapping
	public ResponseEntity<Page<Categories>> getAllCategories(@RequestParam(name = "page", defaultValue = "0") int page,
